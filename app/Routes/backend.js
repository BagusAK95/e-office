...
Route.group(() => {
  ...
  /**
   * @swagger
   * /konsep-surat/pemeriksa/{id}:
   *   put:
   *     tags:
   *       - Konsep Surat
   *     summary: Update dari Pemeriksa
   *     consumes:
   *       - application/x-www-form-urlencoded
   *     produces:
   *       - application/json
   ...
   *         type: string
   */
  Route.put('/konsep-surat/pemeriksa/:id', 'SuratKeluarController.updateConceptChecked').validator('editKonsepSurat').middleware('checkToken:employe,konsepsurat')
